...
class InvalidCredentialsError(BaseError):
    def __init__(
        self, message: str = "Неверный логин или пароль.", status_code=status.HTTP_401_UNAUTHORIZED
    ):
...
class DatabaseUpdateError(BaseError):
    def __init__(
        ...
        super().__init__(
            f"Ошибка при обновлении записи в моделе: {table.__tablename__}", status_code
        )
